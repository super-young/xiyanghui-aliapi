...
class AlibabaopenplatformtradeBizCargoGroup extends SDKDomain
{
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (isset($this->stdResult->{"discount"})) {
            $this->discount = $this->stdResult->{"discount"};
        }
        if (isset($this->stdResult->{"isVirtual"})) {
            $this->isVirtual = $this->stdResult->{"isVirtual"};
        }
        if (isset($this->stdResult->{"cartId"})) {
        ...
        if (isset($this->stdResult->{"buyerCharge"})) {
            $this->buyerCharge = $this->stdResult->{"buyerCharge"};
        }
        if (isset($this->stdResult->{"ext"})) {
            $this->ext = $this->stdResult->{"ext"};
        }
        if (isset($this->stdResult->{"attachedType"})) {
            $this->attachedType = $this->stdResult->{"attachedType"};
        }
        if (isset($this->stdResult->{"free"})) {
            $this->free = $this->stdResult->{"free"};
        }
        if (isset($this->stdResult->{"gift"})) {
            $this->gift = $this->stdResult->{"gift"};
        }
        if (isset($this->stdResult->{"extParams"})) {
        ...
        if (isset($this->stdResult->{"supplierName"})) {
            $this->supplierName = $this->stdResult->{"supplierName"};
        }
        if (isset($this->stdResult->{"warehouse"})) {
        ...
        if (isset($this->stdResult->{"jsonGoodsParam"})) {
        ...
        if (isset($this->stdResult->{"specInfo"})) {
